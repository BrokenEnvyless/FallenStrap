    ...
    public partial class App : Application
    {
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructFallenStrapWebUrl();
        ...
        public static string ConstructFallenStrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.fallenstraplabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.fallenstraplabs.com";
        }
