...
using FallenStrap.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace FallenStrap.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for fallenstraprpc, discord rich presence, or game history
