...
using FallenStrap.RobloxInterfaces;
using FallenStrap.UI.Elements.Bootstrapper.Base;
...
namespace FallenStrap
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"FallenStrap-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "FallenStrap-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one FallenStrap instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingFallenStrap);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "FallenStrap.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://fallenstraplabs.com/wiki/help/fallenstrap-cannot-download-roblox/](https://fallenstraplabs.com/wiki/help/fallenstrap-cannot-download-roblox/)"),
