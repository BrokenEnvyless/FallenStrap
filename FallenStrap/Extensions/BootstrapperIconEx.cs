...
namespace FallenStrap.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconFallenStrapClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconFallenStrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconFallenStrap => Properties.Resources.IconFallenStrap,
                ...
                BootstrapperIcon.IconFallenStrapClassic => Properties.Resources.IconFallenStrapClassic,
                _ => Properties.Resources.IconFallenStrap
            };
        }
    }
}
