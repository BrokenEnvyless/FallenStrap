using FallenStrap.UI.ViewModels;
...
namespace FallenStrap.UI.Elements.Controls
{
    /// <summary>
    ...
    class MarkdownTextBlock : TextBlock
    {
        ...
        private static void OnTextMarkdownChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            // https://github.com/fallenstraplabs/fallenstrap/blob/289b9dec77cf35b2cc6504019bc9c7701626be1f/FallenStrap/UI/Elements/Controls/MarkdownTextBlock.cs#L111
