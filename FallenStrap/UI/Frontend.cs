...
using FallenStrap.UI.Elements.Bootstrapper;
using FallenStrap.UI.Elements.Dialogs;

namespace FallenStrap.UI
{
    static class Frontend
    {
        ...
        public static void ShowPlayerErrorDialog(bool crash = false)
        {
            ...
            string info = String.Format(
                ...
                $"https://fallenstraplabs.com/wiki/help/roblox-crashes-or-does-not-launch/"
            );
        ...
        private static IBootstrapperDialog GetCustomBootstrapper()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!App.LaunchSettings.QuietFlag.Active)
                    ShowMessageBox(string.Format(Strings.CustomTheme_Errors_SetupFailed, ex.Message, "FallenStrap"), MessageBoxImage.Error); // NOTE: FallenStrap is the theme name
        ...
        public static void ShowBalloonTip(string title, string message, System.Windows.Forms.ToolTipIcon icon = System.Windows.Forms.ToolTipIcon.None, int timeout = 5)
        {
            ...
            {
                Icon = Properties.Resources.IconFallenStrap,
