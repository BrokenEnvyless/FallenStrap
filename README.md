> [!CAUTION]
> The only official place to download FallenStrap is this GitHub repository. Any other websites offering downloads or claiming to be us are not owned by us.
...
<p align="center">
    <img src="https://github.com/BrokenEnvyless/FallenStrap/raw/main/Images/FallenStrap-full-dark.png#gh-dark-mode-only" width="380">
    <img src="https://github.com/BrokenEnvyless/FallenStrap/raw/main/Images/FallenStrap-full-light.png#gh-light-mode-only" width="380">
</p>
...
Running into a problem or need help with something? [Check out the Wiki](https://github.com/BrokenEnvyless/FallenStrap/wiki). If you can't find anything, or would like to suggest something, please [submit an issue](https://github.com/BrokenEnvyless/FallenStrap/issues).
...
**A:** No, it shouldn't. FallenStrap doesn't interact with the Roblox client in the same way that exploits do — it only writes to Roblox's own supported client settings file, the same mechanism Roblox itself exposes.
## Features
...
## Installing
Download the [latest release of FallenStrap](https://github.com/BrokenEnvyless/FallenStrap/releases/latest), and run it. Configure your preferences if needed, and install. That's about it!
...
[shield-repo-license]:  https://img.shields.io/github/license/BrokenEnvyless/FallenStrap
[shield-repo-workflow]: https://img.shields.io/github/actions/workflow/status/BrokenEnvyless/FallenStrap/ci-release.yml?branch=main&label=builds
[shield-repo-releases]: https://img.shields.io/github/downloads/BrokenEnvyless/FallenStrap/latest/total?color=981bfe
[shield-repo-latest]:   https://img.shields.io/github/v/release/BrokenEnvyless/FallenStrap?color=7a39fb
...
[repo-license]:  https://github.com/BrokenEnvyless/FallenStrap/blob/main/LICENSE
[repo-actions]:  https://github.com/BrokenEnvyless/FallenStrap/actions
[repo-releases]: https://github.com/BrokenEnvyless/FallenStrap/releases
[repo-latest]:   https://github.com/BrokenEnvyless/FallenStrap/releases/latest
